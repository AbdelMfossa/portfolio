...
MIDDLEWARE = [
    ...
    'portfolio.middleware.VisitorTrackingMiddleware',  # 📊 Tracking visiteurs
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'portfolio.context_processors.visitor_stats',  # 📊 Stats visiteurs globales
            ],
        },
    },
]
...
if not DEBUG:
    ...
    # En dev, on garde les options de base
